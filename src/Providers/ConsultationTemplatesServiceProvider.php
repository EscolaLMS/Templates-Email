...
class ConsultationTemplatesServiceProvider extends ServiceProvider
{
    ...
    {
        Template::register(ApprovedTermWithTrainer::class, EmailChannel::class, ApprovedTermWithTrainer::class);
        Template::register(ApprovedTerm::class, EmailChannel::class, ApprovedTermVariables::class);
        Template::register(RejectTermWithTrainer::class, EmailChannel::class, RejectTermWithTrainer::class);
